...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(nord-theme writeroom-mode)
...
(setq org-time-tracking (org-file-path "time-tracking.org"))
...
(setenv "WORKON_HOME" "/home/well/.cache/pypoetry/virtualenvs/")
